 ...
 */
public class CustomArrayAdapterEditZones extends ArrayAdapter<String> {
    private final Context context;
    private final ArrayList<String> values;

    public CustomArrayAdapterEditZones(Context context, int rowlayout, int label, ArrayList<String> values) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(EditJobZoneChooserActivity.cityList.contains(textView.getText().toString())){
