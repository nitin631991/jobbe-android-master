...
public class RequestsClientArchiveActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sendScreenAnalytics("CLIENTE - PROFILO - STORICO RICHIESTE");
        ...
        for (final ParseObject request : requests){
            ...
            item.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    Intent intent = new Intent(RequestsClientArchiveActivity.this, RequestsArchiveDetailsActivity.class);
